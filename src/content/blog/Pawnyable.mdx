...
date: 2023-12-24
postLayout: simple
summary: Learn the internals of modern linux kernel exploitation bypassing all the mitigations like SMAP, SMEP, KPTI, KASLR. The blogpost contains a linux kernel exploitation series covering variety of bugs and exploitation techniques.
cover: '@/assets/cover/pawnyable.png'
tags:
- "linux"
- "kernel"
- "use-after-free"
...
import lk01 from "@/assets/lk01.png"
import lk02 from "@/assets/lk02.png"
import lk03 from "@/assets/lk03.png"
...
```
<Figure src={lk01} alt="">Holstein 1</Figure>
...
```
<Figure src={lk02} alt="">Holstein 2</Figure>
...
```
<Figure src={lk03} alt="">Holstein 3</Figure>
