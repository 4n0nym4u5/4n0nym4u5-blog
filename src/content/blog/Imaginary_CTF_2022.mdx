...
postLayout: simple
draft: false
summary: I played this CTF with Project Sekai and we came 3rd in this CTF. I solved Format String Fun, minecraft, zookeeper with my team. Recommended read minecraft which uses House of Husk a fancy heap exploitation technique
cover: '@/assets/cover/imaginary.gif'
tags:
  - "linux"
  - "ctf"
  - "format-string"
