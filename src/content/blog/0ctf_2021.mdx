...
import gen_hash from "@/assets/gen_hash.png"
import gen_hash_poc from "@/assets/gen_hash_poc.png"
...
<Figure src={gen_hash} alt="" width="400" height="400"></Figure>
...
<Figure src={gen_hash_poc} alt="" width="400" height="400">gen_hash Integer underflow Proof-of-Concept</Figure>
