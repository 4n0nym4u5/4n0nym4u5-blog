...
date: 2022-01-10
postLayout: simple
cover: '@/assets/cover/inctf.png'
summary: Introductory blog detailed with how to effectively setup weird architecture exploit environment with the help of qemu emulation and debugging with gdb server.
tags:
- "linux"
- "ctf"
- "mips"
