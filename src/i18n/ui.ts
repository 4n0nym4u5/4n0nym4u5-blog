...
export const ui = {
  'en': {
    // Site Metadata
    'siteMetadata.title': '4n0nym4u5 Blog',
    'siteMetadata.headerTitle': '4n0nym4u5 Blog',   
    'siteMetadata.description': 'This blog contains my CTF Writeups and vulnerability research content',
